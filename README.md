...
**⚠️TIP :**
Troubleshooting: If a warning appears to enable cheats when using the` /server` command, it is recommended to use an additional **[plugin](https://github.com/TegarPriyadi/WaterdogPE-Plugins)** as an alternative to the server switching system for more stability.
